...
<body>
    ...
    <header uk-sticky>
        ...
        <ul class="uk-breadcrumb uk-container">
            <li><a href="javascript:history.back();">パスワード変更</a></li>
...
<!--高橋UIゾーン--><!--アイコンの位置-->
        ...
        <table class="uk-table">
            <tr>
                ...
                <td><span class="GREEN_marker"><?php echo $pw;?></span></td>
            </tr>
        </table>
        <br>
        <!--button-->
        <div class="uk-flex uk-flex-between">
            <div class="uk-flex-last"><!--変更-->
                <a href="password_compleated.php" class="uk-button uk-button-primary">変更</a>
            </div>
            <div class="uk-flex-first"><!--戻る-->
            <!--櫻間-->
                <a href="password_control.php" class="uk-button uk-button-primary">戻る</a>
            </div>
        </div>
    <!--/form-->
    </div>
