...
/* 見出し固定*/
    ...
    */
    /* 奇数行 */
        .table-green2 tbody tr:nth-child(odd) td{
        background: rgb(226,239,218);  /* （薄緑） */
        }
    /* 偶数行 */
        .table-green2 tbody tr:nth-child(even) td{
...
<!-- JSここまで -->
    ...
    <thead>
        <tr class="table-success ">
            <th rowspan='2'style="border: solid 1px #FFFFFF";>年度</th>
...
<!-- 20240312 白くなる原因はtbodyに対するCSSが以前に実装されていたため　直接style記入のままでOK -->
        <tr class="js-filter" data-nendo="<?php echo $var['year'];?>" data-kbn="<?php echo $var['ins'];?>" data-date="<?php echo $var['date'];?>">       
