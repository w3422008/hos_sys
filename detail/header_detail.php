    ...
    <form class="uk-form-stacked " id="form" action="../search/search_control.php" method="POST">
      <ul class="uk-breadcrumb breadcrumb">
        ...
        <li><button name="detail" value="<?php echo $page_id; ?>" id="save" class="uk-text-link"
            style="border:none; outline:none; background:none;">検索結果</button></li><?php //高橋20230329追記 ページング保持（管理者） ?>
    ...
    <main>
      <div class="uk-container uk-width-expand uk-width-5-6@l uk-card-default">
        ...
        <div class="print-area">
          ...
          <div class="tab-wrap">
            ...
            <input id="tab07" type="radio" name="tab" class="tab-switch"><label class="tab-label"
              for="tab07">連携状況</label>
            ...
            <input id="tab09" type="radio" name="tab" class="tab-switch"><label class="tab-label"
              for="tab09">診療内容</label>
      ...
      <div class="uk-flex uk-flex-center">
        <?php foreach ($data as $key => $var): ?>
          <div>
            <a href="../delete/hide_control.php?sid=<?php echo $var['hos_cd']; ?>"
              class="uk-button uk-button-large uk-button-default"><i class="fas fa-ban fa-2x"></i> 停止</a>
          </div>
        <?php endforeach; ?>
        <div>
          <button type="submit" class="uk-button uk-button-large uk-button-default"><i class="fas fa-edit fa-2x"></i>
            変更</button>
        </div>
        ...
        <!-- ドロップダウンメニューと印刷ボタン -->
        <div class="uk-inline">
          <button id="printPageButton" class="uk-button uk-button-large uk-button-default" type="button"><i
              class="fas fa-print fa-2x"></i> 印刷</button>
