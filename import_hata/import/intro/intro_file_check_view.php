...
<!--     <footer uk-sticky="position: bottom">
 ...
 -->
    ...
    <form action = "intro_import.php" method="POST">
        ...
        <div class="uk-card-default uk-container uk-container-center uk-width-2-3@m">
            ...
            <div class="uk-flex uk-flex-between">
                <div class=" uk-flex-last">
                    <?php if(empty($errors)){?>
                    <button type="submit" name = "enter" value="<?php echo htmlspecialchars( basename( $file_name)); ?>" class="uk-button uk-button-primary">追加</button>  
                    <?php }?>
                </div>
