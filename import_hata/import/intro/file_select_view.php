...
<body>
    ...
    <!-- ファイルのドラッグアンドドロップ欄（紹介データインポート） 月 -->
    <div class="mt-3">
        <div class="detail-section" id="intro_in"><!-- 区分 -->
            <div style="width: 72%; margin-left: 4%;">
                <h4>紹介データインポート -１か月</h4>
            </div>

        <form id="file_upload_form1" method="post" enctype="multipart/form-data" action="intro_file_check_month.php">
            <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                <div id="file_drag_drop_area1" class="text-center p-3 rounded col-md-10 mx-auto dashed-border" style="width: 70%;">
                    使用不可<br/>
                    <span>または</span><br/>
                    <input id="myFile1-1" type="file" name="filename" multiple />
                </div>
    ...
    <!-- ファイルのドラッグアンドドロップ欄（紹介データインポート） 年 -->
    <div class="mt-3">
        <div class="detail-section" id="intro_in"><!-- 区分 -->
            <div style="width: 72%; margin-left: 4%;">
                <h4>紹介データインポート -１年</h4>
        ...
        <form id="file_upload_form1" method="post" enctype="multipart/form-data" action="intro_file_check.php">
            <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                <div id="file_drag_drop_area1" class="text-center p-3 rounded col-md-10 mx-auto dashed-border" style="width: 70%;">
                    ...
                    <span>または</span><br/>
                    <input id="myFile2-1" type="file" name="filename" multiple />
                </div>
    ...
    <!-- ファイルのドラッグアンドドロップ欄（逆紹介データインポート） 月 -->
    <div class="mt-3">
        <div class="detail-section" id="invers_intro_in"><!-- 区分 -->
            <div style="width: 72%; margin-left: 4%;">
                <h4>逆紹介データインポート -１か月</h4>
            </div>
        ...
        <form id="file_upload_form2" method="post" enctype="multipart/form-data" action="inv_intro_file_check.php">
            <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                <div id="file_drag_drop_area2" class="text-center p-3 rounded col-md-10 mx-auto dashed-border" style="width: 70%;">
                    使用不可<br/>
                    <span>または</span><br/>
                    <input id="myFile1-2" type="file" name="filename" multiple />
                </div>
    ...
    <!-- ファイルのドラッグアンドドロップ欄（逆紹介データインポート） 年 -->
    <div class="mt-3">
        <div class="detail-section" id="invers_intro_in"><!-- 区分 -->
            <div style="width: 72%; margin-left: 4%;">
                <h4>逆紹介データインポート -１年</h4>
            </div>
        ...
        <form id="file_upload_form2" method="post" enctype="multipart/form-data" action="inv_intro_file_check.php">
            <div style="display: flex; justify-content: space-between; align-items: flex-end;">
                <div id="file_drag_drop_area2" class="text-center p-3 rounded col-md-10 mx-auto dashed-border" style="width: 70%;">
                    ここにファイルをドラッグ&ドロップ<br/>
                    <span>または</span><br/>
                    <input id="myFile2-2" type="file" name="filename" multiple />
                </div>
