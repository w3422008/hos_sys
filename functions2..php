...
function update_message($dbh,$id,$situation,$req_date,$res_date,$comment,$req_fac,$req_dep,$view){

    $sql = "UPDATE message SET situation=:situation,req_date=:req_date,res_date=:res_date,comment=:comment,req_fac=:req_fac,req_dep=:req_dep,view=:view WHERE id=:id";
