...
<body>
    ...
    <main>
        ...
        <h2><i class="fas fa-lock-open fa-lg"></i> 停止解除完了</h2>
            <p><i class="fas fa-check-circle"></i> 停止解除完了：医療機関が再表示されました。</p>
        </div>
        </div>
        ...
        <div class="uk-flex uk-flex-around">
            <div>
                <a href="hide_hos_control.php" class="uk-button uk-button-primary">医療機関削除画面に戻る</a>
            </div>
        </div>
    </main>
</body>
