...
<head><link rel="shortcut icon" href="../favicon.ico">
    ...
    <title>医療機関 停止解除 | 医療機関情報システム</title>
      <!--CSS/JS-->
        <!-- *全画面必須 ---------->
          <!--UIkit3-->
    ...
    ?>
        <div class="uk-alert-success">
            ...
            <div class="uk-card-header">
                <h2><i class="fas fa-lock-open fa-lg"></i> 医療機関 停止解除</h2>
                <p>「<b>停止解除</b>」をクリックすると 医療機関情報が再度 検索結果一覧に表示されます。</p>
            </div>
        </div>
        ...
        <div class="uk-width-1-1 uk-container">
            ...
            <div class="uk-flex uk-flex-between">
                <div class="uk-margin-left">
                    <a href="hide_hos_control.php?sid=<?php echo $var['hos_cd'];?>" class="uk-button uk-button-primary">戻る</a>
                </div>
                <div class="uk-margin-right">
                    <a href="undid_control.php?sid=<?php echo $var['hos_cd'];?>" class="uk-button uk-button-primary">停止解除</a>
                </div>
            </div>
            </div>
        </div>
