...
<head><link rel="shortcut icon" href="../favicon.ico">
    ...
    <title>ユーザー利用停止 | 医療機関情報システム</title>
    <!--CSS/JS-->
    <!-- *全画面必須 ---------->
        <!--UIkit3-->
...
<body>
    ...
    <div class="uk-container uk-card userCard uk-width-expand uk-width-5-6@l uk-width-2-3@xl">
        ...
        <div class="uk-card-header">
            <h2 class="uk-heading-primary"><i class="fas fa-lock"></i> ユーザー利用停止</h2>
            <span>「<b>利用停止</b>」をクリックすると、利用停止されます</span>
        </div>
        ...
        ?>
            ...
            <div class="uk-flex uk-flex-between">
                ...
                <div class="uk-margin-right">
                    <a href="switch.php?sid=<?php echo $var['user_id'];?>" class="uk-button uk-button-primary">利用停止</a>
                </div>
            </div>    
        <?php
        endforeach; 
