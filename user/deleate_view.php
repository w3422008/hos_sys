...
<body>
    ...
    <div class="uk-container uk-card userCard uk-width-expand uk-width-5-6@l uk-width-2-3@xl">
        ...
        <div class="uk-card-header">
            <h2 class="uk-heading-primary"><i class="fas fa-trash"></i> ユーザー削除</h2>
            <span>「<b>削除</b>」をクリックすると、ユーザーが削除されます。</span><br>
            <u>※一度削除したユーザーは元に戻すことはできません。</u>
        </div>
        ...
        ?>
            ...
            <div class="uk-flex uk-flex-between">
                ...
                <div class="uk-margin-right">
                    <a href="deleated.php?sid=<?php echo $var['user_id'];?>" class="uk-button uk-button-danger">削除</a>
                </div>
            </div>
        <?php
        endforeach; 
