        ...
        <ul class="uk-nav uk-navbar-dropdown-nav" uk-margin>
            ...
            <li>
                <div class="uk-margin-small">
                    ...
                    <select class="uk-select uk-form-small" id="permission-change"
                    ...
                    <?php if (isset($is_temp_changed)): ?>
                        <button class="uk-button uk-button-small uk-button-secondary uk-margin-small-top"
                            style="font-size: 11px; width: 100%;" onclick="">
                            元の権限に戻す
                        </button>
                    <?php endif; ?>
                </div>
            ...
            <li class="uk-nav-divider"></li>
            <li><a href="<?php echo password_URL; ?>"><span class="uk-margin-small-right" uk-icon="icon: cog"></span>
                    パスワード変更</a></li>
            <li><a href="<?php echo logout_URL; ?>"><span class="uk-margin-small-right" uk-icon="icon: sign-out"></span>
                    ログアウト</a></li>
        </ul>
    </div>
    <?php
    ...
    <div class="uk-navbar uk-flex-middle bg-navbar3">
        ...
        <div class="uk-navbar uk-visible@m"><!-- Link -->
            ...
            <ul class="uk-navbar-nav">
                ...
                <li>
                    <a class="uk-button uk-button-link" id="manual-btn" type="button"><i
                            class="fa-solid fa-book fa-2x"></i>マニュアル</a>
                </li>
            </ul>
...
<div id="manual-modal" uk-modal>
    <div class="uk-modal-dialog uk-modal-body" style="min-width:60vw; min-height:80vh;">
        ...
        <iframe id="manual-pdf-frame"
            src="<?php echo $user_adm == 3 ? SYSADM_MANUAL_URL : ($user_adm == 1 ? ADM_MANUAL_URL : MANUAL_URL); ?>"
