...
<head><link rel="shortcut icon" href="../favicon.ico">
    ...
    <title>検索結果一覧 | 医療機関情報システム</title><!--★1103確認済-->
<!--CSS/JS-->
<!-- *全画面必須 ---------->
  <!--UIkit3-->
...
?>
    ...
    <a href="<?php SITE_URL ?>search_control.php?page_id=<?php echo ($now - 1);?>">前へ</a>
<?php
} else {
    echo '前へ'. '　';
}
...
if($now < $max_page){ // リンクをつけるかの判定
    ...
    <a href="<?php SITE_URL ?>search_control.php?page_id=<?php echo ($now + 1);?>">次へ</a>
<?php
} else {
    echo '次へ';
}
...
<!--**Cards----->        
  ...
  <h3>
    <a href="../detail/detail_control.php?cd=<?php echo html_escape ($var['hos_cd']); ?>&page_id=<?php echo $now; ?>" class="link" style="text-decoration:none;">
  ...
  <div uk-grid>
    <div class="uk-width-1-5@s"><!--医療機関 基本情報-->
      <fieldset class="uk-margin-small uk-fieldset" id="search-intro">
    ...
    <div class="uk-width-1-3@s">
      ...
      <fieldset class="uk-fieldset" id="search-intro">
        <table class="uk-margin-small uk-table-small tbl-border" style="text-align: center;">
...
?>
          ...
          <tr>
            <th>AM</th>
            <td> <?php if($var['mon_am'] == '●'){ echo '○'; }elseif($var['mon_am'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間 月AM-->
            <td><?php if($var['tue_am'] == '●'){ echo '○'; }elseif($var['tue_am'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間火AM-->
            <td><?php if($var['wed_am'] == '●'){ echo '○'; }elseif($var['wed_am'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間 水AM-->
            <td><?php if($var['thr_am'] == '●'){ echo '○'; }elseif($var['thr_am'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間 木AM-->
            <td><?php if($var['fri_am'] == '●'){ echo '○'; }elseif($var['fri_am'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間 金AM-->
            <td><?php if($var['sat_am'] == '●'){ echo '○'; }elseif($var['sat_am'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間 土AM-->
            <td><?php if($var['sun_am'] == '●'){ echo '○'; }elseif($var['sun_am'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間 日AM-->
            <td rowspan="2"><?php if($var['holiday'] == '●'){ echo '○'; }elseif($var['holiday'] == '★'){echo '★';}else{ echo '×';} ?></td><!--高橋櫻間 祝日--><!--櫻間-->
          </tr>
          <tr>
            <th>PM</th>
            <td><?php if($var['mon_am'] == '●'){ echo '○'; }elseif($var['mon_am'] == '★'){echo '★';}else{ echo '×';} ?></td>
...
<?php
    ...
    <div class="uk-width-1-5@s">
      <fieldset class="uk-fieldset" id="search-ass"><!--診療科-->
...
//
  ...
  ?>
    ...
    <div class="uk-width-1-4@s uk-child-width-1-1@s" uk-grid>
        <fieldset class="uk-fieldset"><!--紹介・逆紹介-->
        <h4><span uk-icon="triangle-right"> </span>紹介・逆紹介</h4>
          <ul class="uk-margin-remove-top uk-margin-small-left">
          <li>紹介：
            <?php 
              //櫻間20230616から
              if($var['intr'] !== '0'){
...
?>
    <a href="<?php SITE_URL ?>search_control.php?page_id=<?php echo $i;?>"><?php echo $i; ?></a>,<!--櫻間-->
<?php
    }
}
...
<div class="uk-margin-top uk-container uk-container-center uk-width-4-5@m">
    <p class="uk-text-danger"><span uk-icon="warning"></span> <b style="border-bottom:1px solid;">検索結果なし</b>：検索条件に一致する医療機関がございません。</p>
</div>
