        ...
        <div class="uk-navbar uk-visible@m"><!-- Link -->          
            <?php if($user_adm === '1'){ ?>
                <ul class="uk-navbar-nav">
                    <li class="uk-active">
                        <a href="../message/mess_mainte/mainte.php"><i class="fas fa-screwdriver-wrench fa-2x"></i></i>メンテナンス通知</a>
                    </li> 
                    <li>
                        <a href="../message/mess_mainte_start/mainte.php"><i class="fas fa-screwdriver-wrench fa-2x"></i></i>メンテナンス開始・停止</a>
                    </li> 
                    <li>
                        <a href="../message/mes_log.php"><i class="far fa-comment fa-2x"></i></i>メッセージ</a>
                    </li>                  
                </ul>
            <?php } ?>
        </div>
