...
<body>
    ...
    <header uk-sticky>
        ...
        <ul class="uk-breadcrumb breadcrumb">
            ...
            <li><a href="/hos_sys/message/mes_log.php">メッセージ画面</a></li>
    ...
    <form action = "mes_display_comp.php" method="POST">

    <!--*main_header-->
    <div class="uk-card-default uk-container uk-container-center uk-width-2-3@m">
        <div class="uk-card-header">
            <h2>確認</h2>
            <span>この内容を<?php if($display_data[0]['view']){echo '非表示';}else{echo '表示';} ?>にしてよろしいですか？</span>
        </div>
    ...
    <!--⭐UIゾーン--><!--アイコンの位置-->
                <div>
                    ...
                    <?php foreach($display_data as $key => $var): ?>
                        <tr>
                        <th>依頼者　施設</th>
    ...
    <div class="uk-flex uk-flex-between">
                <div class=" uk-flex-last">
                   <button type="submit" name = "mes_display" value="表示非表示" class="uk-button  uk-button-primary"><?php if($display_data[0]['view']){echo '非表示';}else{echo '表示';} ?></button>  
                </div>
