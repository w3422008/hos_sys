...
<body>
    ...
    <form action = "../mess_mainte_start/add_comp.php" method="POST">
    ...
    <!--⭐UIゾーン--><!--アイコンの位置-->
                <div>
                    <table class="uk-table uk-table-divider">
                        ...
                        <th>メンテナンスモード　オン／オフ</th>
                            <td><?php if($view === "0"){echo "オフ";}
                                    elseif($view === "1"){echo "オン";} ?>
                            </td>
                        </tr>

                        <tr>
                        <th>実施内容</th>
                            <td><?php echo $comment2; ?>
                            </td>
                        </tr>
            ...
            <div class="uk-flex uk-flex-between">
                <div class=" uk-flex-last">
                    <button type="submit" name = "start_add" value="追加" class="uk-button uk-button-primary">保存</button> 
                </div>
                <div class=" uk-flex-first">
                    <button type="submit" name = "start_back" value="戻る" class="uk-button uk-button-primary">戻る</button> 
                </div>
            </div>
