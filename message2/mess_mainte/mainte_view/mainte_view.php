...
<body>
    ...
    <form action="../mess_mainte/add.php" method="POST"  name="myform" onsubmit="return Check()" class="validationForm" >
        <p></p>
        ...
        <div class="uk-margin uk-container uk-container-center uk-width-1-1@m">
            ...
            <div>
                <table class="uk-table uk-table-divider">
                    ...
                    <th>作業日</th>
                        <td><div class="uk-form-controls">
                            <input type="date" class="uk-input size-input-hosCd pattern" name="mai_date"  value="<?php if(isset($date)){echo $date; } ?>" min="2000-01-01" max="2030-12-31" required>
                        </div></td>
                    </tr>
                    ...
                    <th>表示／非表示</th>
                        <td><div class="uk-form-controls">
                            <select name="mai_view"  class="uk-select size-input-pre" id="selbox3" onchange="change();">
                    ...
                    <tr>
                    <th>実施内容</th>   
                        <td><div><textarea class="uk-textarea size-textarea-Notes meslog" rows="4" name="mai_comment"  placeholder="改行の際は文末の後ろに<br>を入れてください" maxlength="150"><?php if(isset($comment)){echo $comment; } ?></textarea></div></td>
                    </tr>
