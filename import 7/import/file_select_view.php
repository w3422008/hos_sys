    ...
    <ul class="uk-switcher uk-margin">
        ...
        <li>
            <div class="mt-3">
                    ...
                    <form id="file_upload_form_intro_month" method="post" enctype="multipart/form-data">
                        <div class="uplade_content">
                            <div id="file_drag_drop_area_intro_month" class="file_drag_drop_area display_left rounded dashed-border">
                                ...
                                <br><span id="fileName_intro_month"></span>
                ...
                <ul>
<?php
                        foreach ($folderFiles['BK_intro'] as $i => $csv): 
                            $csvId = 'csv-preview-intro-' . $i;
                            $filePath = __DIR__ . '/BK_intro/' . $csv;
                            $tableHtml = getCsvTableHtml(__DIR__ . '/', ['BK_intro'], 'BK_intro/' . $csv);
?>
                            <li>
                                <?php echo htmlspecialchars($csv); ?>
                                <span style="color:#888; font-size:0.95em;">
                                    （保存日時：<?php echo getSavedDatetimeFromFilename($csv); ?>）
                                </span>
                                <button type="button" class="uk-button uk-button-default"
                                    onclick="showCsvModal('<?php echo $csvId; ?>',  '<?php echo getSavedDatetimeFromFilename($csv) ?>')">
                                    プレビュー
                                </button>
                                <a class="uk-button uk-button-primary" href="<?php echo './BK_intro/' . rawurlencode($csv); ?>" download>ダウンロード</a>
                                <div id="<?php echo $csvId; ?>" style="display:none;"><?php echo $tableHtml; ?></div>
                            </li>
<?php
                        endforeach;
?>
        ...
        <li>
            <div class="mt-3">
                ...
                <div class="detail-section">
                    ...
                    <ul>
<?php
                    foreach ($folderFiles['BK_invers_intro'] as $csv):
                        $csvId = 'csv-preview-invintro-' . $csv;
                        $filePath = __DIR__ . '/BK_invers_intro/' . $csv;
                        $tableHtml = getCsvTableHtml(__DIR__ . '/', ['BK_invers_intro'], 'BK_invers_intro/' . $csv);
?>
                        <li>
                            <?php echo htmlspecialchars($csv); ?>
                            <span style="color:#888; font-size:0.95em;">
                            ...
                            <a class="uk-button uk-button-primary" href="<?php echo './BK_invers_intro/' . rawurlencode($csv); ?>" download>ダウンロード</a>
                            <div id="<?php echo $csvId; ?>" style="display:none;"><?php echo $tableHtml; ?></div>
                        </li>
<?php
                    endforeach;
        ...
        <li>
            <div class="mt-3">
                ...
                <div class="detail-section">
                    ...
                    <ul>
<?php
                        foreach ($folderFiles['BK_contact'] as $i => $csv): 
                            $csvId = 'csv-preview-contact-' . $i;
                            $filePath = __DIR__ . '/BK_contact/' . $csv;
                            $tableHtml = getCsvTableHtml(__DIR__ . '/', ['BK_contact'], 'BK_contact/' . $csv);
?>
                            <li>
                                <?php echo htmlspecialchars($csv); ?>
                                <span style="color:#888; font-size:0.95em;">
                                ...
                                <a class="uk-button uk-button-primary" href="<?php echo './BK_contact/' . rawurlencode($csv); ?>" download>ダウンロード</a>
                                <div id="<?php echo $csvId; ?>" style="display:none;"><?php echo $tableHtml; ?></div>
                            </li>
<?php
                        endforeach;
        ...
        <li>
            <div class="mt-3">
                ...
                <div class="detail-section">
                    ...
                    <ul>
<?php   
                    foreach ($folderFiles['BK_training'] as $csv):
                        $csvId = 'csv-preview-training-' . $csv;
                        $filePath = __DIR__ . '/BK_training/' . $csv;
                        $tableHtml = getCsvTableHtml(__DIR__ . '/', ['BK_training'], 'BK_training/' . $csv);
?>
                        <li>
                            <?php echo htmlspecialchars($csv); ?>
                            <span style="color:#888; font-size:0.95em;">
                            ...
                            <a class="uk-button uk-button-primary" href="<?php echo './BK_training/' . rawurlencode($csv); ?>" download>ダウンロード</a>
                            <div id="<?php echo $csvId; ?>" style="display:none;"><?php echo $tableHtml; ?></div>
                        </li>
<?php
                    endforeach;
?>
    ...
    <div id="csv-modal" uk-modal>
        <div id="csv-modal-body" class="uk-modal-dialog uk-modal-body">
            <button class="uk-modal-close-default" type="button" uk-close></button>
            <h2 class="uk-modal-title" id="csv-modal-title">プレビュー</h2>
            <span id="csv-modal-subtitle"></span>
            <div id="csv-modal-content" class="csv-table-container">
            </div>
        </div>
    </div>
