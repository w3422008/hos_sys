...
<head><link rel="shortcut icon" href="../favicon.ico">
    ...
    <title>メンテナンス 院外診療支援・院外研修データ取込み | 医療機関情報システム</title>
<!--CSS/JS-->
  <!-- *全画面必須 ---------->
    <!--UIkit3-->
...
<header>
  ...
  <ul class="uk-breadcrumb breadcrumb">
      ...
      <li><span>メンテナンス　院外診療支援・院外研修データ取込み</span></li>
  </ul>
  </div>
</div>
</header>
...
<div class="uk-card uk-card-small">
    ...
    <div class="uk-container uk-container-center uk-width-2-3@m">
        ...
        <h4 class='uk-heading-primary'>メンテナンス　院外診療支援・院外研修データ取込み</h4>
        </div>
    </div>
<br><br>
    <!--*main_body-->
