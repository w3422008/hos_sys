...
<body>
    ...
    <?php if ($user_type === 'admin'): ?>
      ...
      <form class="uk-form-stacked" id="form" action="../search/search_control.php" method="POST">
        <ul class="uk-breadcrumb breadcrumb">
          ...
          <li><button name="detail" value="<?php echo $page_id; ?>" id="save" class="uk-text-link"
              style="border:none; outline:none; background:none;">検索結果</button></li>
  ...
  <main>
    <div class="uk-container uk-width-expand uk-width-5-6@l uk-card-default">
      ...
      <!-- Form / Content -->
      <?php if ($user_type === 'admin'): ?>
        <form action="../update/kakunin.php" method="POST" name="myform" onsubmit="return Check()" class="validationForm"
          novalidate>
        <?php else: ?>
          ...
          <div class="print-area">
            ...
            <div class="tab-wrap">
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content01">
                <p>基本情報</p>
                <a href="#to-hospitalName" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 医療機関名</a>
                <a href="#to-kubun" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 区分</a>
                <a href="#to-Medass" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 医師会</a>
                <a href="#to-area" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i class="fas fa-hashtag"></i>
                  所在地</a>
                <a href="#to-address" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 連絡先</a>
                <a href="#to-note1" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content02">
                <p>診療時間・診療科等</p>
                <a href="#to-BedReha" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 許可病床数・病棟種類・リハビリスタッフ</a>
                <a href="#to-week" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i class="fas fa-hashtag"></i>
                  診療日・手術日、診療時間</a>
                <a href="#to-Dept" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i class="fas fa-hashtag"></i>
                  診療科</a>
                <a href="#to-note2" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content04">
                <p>部門連絡先</p>
                <a href="#to-Fiejct" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 部門連絡先</a>
                <a href="#to-note4" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content05">
                <p>紹介・逆紹介</p>
                <a href="#to-kurashiki" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 附属病院（紹介・逆紹介）</a>
                <a href="#to-okayama" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 総合医療センター（紹介・逆紹介）</a>
                <a href="#to-note5" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content06">
                <p>兼業</p>
                <a href="#to-SprtTrng" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 兼業</a>
                <a href="#to-note6" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content07">
                <p>連携状況</p>
                <a href="#to-carna" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> カルナコネクト</a>
                <a href="#to-path" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i class="fas fa-hashtag"></i>
                  連携パス</a>
                <a href="#to-socialMeeting" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 医療連携懇話会 参加年度</a>
                <a href="#to-note7" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content08">
                <p>コンタクト履歴</p>
                <a href="#to-contact" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> コンタクト履歴</a>
                <a href="#to-note8" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
              ...
              <div class="tab-content <?php echo $user_type === 'admin' ? 'non-printable' : ''; ?>" id="tab-content09">
                <p>診療内容</p>
                <a href="#to-Medcare" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 受入可能な診療内容</a>
                <a href="#to-note9" <?php echo $user_type === 'admin' ? 'uk-scroll' : ''; ?>><i
                    class="fas fa-hashtag"></i> 備考</a>
    ...
    <div class="uk-flex uk-flex-center">
      <?php if ($user_type === 'admin'): ?>
        <div>
          <a href="../delete/hide_control.php?sid=<?php echo $hos_cd; ?>"
            class="uk-button uk-button-large uk-button-default">
      ...
      <div class="uk-inline">
        ...
        <div uk-dropdown="mode: click">
          <ul class="uk-nav uk-dropdown-nav">
            <li><a href="#" id="tab-content01" data-tab-name="基本情報"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">基本情報</a></li>
            <li><a href="#" id="tab-content02" data-tab-name="診療時間・診療科等"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">診療時間・診療科等</a></li>
            <?php if ($user_type === 'admin'): ?>
              <li><a href="#" id="tab-content03" data-tab-name="理事長・病院長情報"
                  onclick="printTab(this.id, this.getAttribute('data-tab-name'))">理事長・病院長情報</a></li>
            <?php endif; ?>
            <li><a href="#" id="tab-content04" data-tab-name="部門連絡先"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">部門連絡先</a></li>
            <li><a href="#" id="tab-content05" data-tab-name="紹介・逆紹介"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">紹介・逆紹介</a></li>
            <li><a href="#" id="tab-content06" data-tab-name="兼業"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">兼業</a></li>
            <li><a href="#" id="tab-content07" data-tab-name="連携状況"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">連携状況</a></li>
            <li><a href="#" id="tab-content08" data-tab-name="コンタクト履歴"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">コンタクト履歴</a></li>
            <li><a href="#" id="tab-content09" data-tab-name="診療内容"
                onclick="printTab(this.id, this.getAttribute('data-tab-name'))">診療内容</a></li>
          </ul>
        </div>
      </div>
