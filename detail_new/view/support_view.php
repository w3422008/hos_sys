<?php
// detail_control.phpから$training_data, $dataが渡されている
?>
...
<h4>備考
    ...
    <?php foreach ($data as $key =>$var): ?>
        <textarea class="uk-textarea size-textarea-Notes" name="tra_note" rows="7" maxlength="1000"><?php echo html_escape(trim($var['tra_note'])) ?></textarea>
    <?php endforeach; ?>
    </div>
</div>
