<?php
// detail_control.phpから$intr_data, $intr_sum, $Years等が渡されている
?>
...
<h4>備考
    ...
    <div class="uk-form-controls">
        <textarea class="uk-textarea size-textarea-Notes" name="intr_note" rows="7" maxlength="1000"><?php echo html_escape(trim($var['intr_note'])) ?></textarea>
    </div>
</div>
<?php
endforeach;
