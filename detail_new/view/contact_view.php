<?php
// detail_control.phpから$contact_data, $dataが渡されている
?>
...
<!-- 桜-->
<div class="detail-section" id="to-note8"><!-- 備考 -->
<h4>備考
    <label class="uk-form-label">（自由入力、1000文字以内）</label></h4>
    <div class="uk-form-controls">
    <?php foreach($data as $var): ?>
        <textarea class="uk-textarea size-textarea-Notes" name="con_note" rows="7" maxlength="1000"><?php echo html_escape(trim($var['con_note'])) ?></textarea>
    <?php endforeach; ?>
    </div>
</div>
</div>
